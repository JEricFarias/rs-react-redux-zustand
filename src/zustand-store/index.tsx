...
export interface PlayerState {
  ...
  load: () => Promise<void>;
  play: (moduleLessonIndex: [number, number]) => void;
  next: () => void;
}
...
export const useStore = create<PlayerState>()((set, get) => ({
  ...
  play: (moduleLessonIndex: [number, number]) => {
    const [moduleIndex, lessonIndex] = moduleLessonIndex;
...
export function useCurrentModule() {
  return useStore((state) => state.course?.modules[state.currentModuleIndex]);
}
